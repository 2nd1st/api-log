...
// authentication middleware to avoid timing leaks per SECURITY.md
// threat model.
//
// The expected token is the 64-char hex value generated by EnsureToken;
// its length is a fixed public constant of the project. Any candidate
// whose length differs is rejected up front — there is no length to
// leak. subtle.ConstantTimeCompare then runs on equal-length inputs.
